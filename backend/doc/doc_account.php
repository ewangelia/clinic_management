                            ...
                            <div class="col-lg-6 col-xl-6">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Nama Dokter :</strong> <span class="ml-2"><?php echo $row->nama_user;?></span></p>
                                       <p class="text-muted mb-2 font-13"><strong>Spesialisasi :</strong> <span class="ml-2"><?php echo $row->spesialisasi;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>NIK :</strong> <span class="ml-2"><?php echo $row->nik;?></span></p>
