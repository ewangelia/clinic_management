<?php
    ...
    $stmt->bind_param('is', $id_user, $nik);
    $stmt->execute();
    $res = $stmt->get_result();
        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="assets/images/users/<?php echo $row->img_user;?>" alt="img_user" class="rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <div class="dropdown-header noti-title">
                        <h6 class="text-overflow m-0">Welcome Doc!</h6>
                    </div>
        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                ...
                <span class="logo-sm">
                    ...
                    <img src="assets/images/logo-sm-white.png" alt="" height="34">
                </span>
            </a>
        </div>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="add_medical_report.php" class="dropdown-item">
