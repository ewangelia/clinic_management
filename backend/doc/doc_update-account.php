<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_profile']))
		{
		    ...
		    move_uploaded_file($_FILES["img_user"]["tmp_name"],"assets/images/users/".$_FILES["img_user"]["name"]);

            //sql to insert captured values
			$query="UPDATE users SET nama_user=?,  img_user=? WHERE id_user = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssi', $nama_user,  $img_user, $id_user);
			$stmt->execute();
			/*
        ...
        if(isset($_POST['update_pwd']))
		{
            ...
            //sql to insert captured values
			$query="UPDATE users SET pwd =? WHERE nik = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ss', $pwd, $nik);
			$stmt->execute();
			/*
			*Use Sweet Alerts Instead Of This Fucked Up Javascript Alerts
			*echo"<script>alert('Successfully Created Account Proceed To Log In ');</script>";
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    <img src="../doc/assets/images/users/<?php echo $row->img_user;?>" class="rounded-circle avatar-lg img-thumbnail"
                                        alt="profile-image">
                                    ...
                                    <div class="text-centre mt-3">
                                        ...
                                        <p class="text-muted mb-2 font-13"><strong>Spesialisasi:</strong> <span class="ml-2"><?php echo $row->spesialisasi;?></span></p>
                                        <p class="text-muted mb-2 font-13"><strong>No IDI :</strong> <span class="ml-2"><?php echo $row->no_user;?></span></p>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="nama_user"  class="form-control" id="nama_user" placeholder="<?php echo $row->nama_user;?>">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" name="img_user" class="form-control btn btn-success" id="useremail" >
                                                            </div>
                                                        </div>
